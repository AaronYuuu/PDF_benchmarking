...
EXTRACTION_TEMPLATE = {
    ...
    "ordering_clinic": ["Children's Hospital of Eastern Ontario (Ottawa)", "Grand River Hospital (Kitchener)", "Hamilton Health Sciences (Hamilton)", "Health Sciences North (Sudbury)", "Hospital for Sick Children (Toronto)", "Kingston Health Sciences Centre (Kingston)", "Lakeridge Health (Oshawa)", "London Health Sciences Centre (London)", "Mackenzie Health (Richmond Hill)", "North York General Hospital (Toronto)", "Orillia Soldiers Memorial Hospital (Orillia, Simcoe/Muskoka)", "Peterborough Regional Health Centre (Peterborough)", "Princess Margaret Hospital (Toronto)", "Sinai Health System (Toronto)", "Sunnybrook Health Sciences (Toronto)", "Thunder Bay Regional Health Sciences Centre (Thunder Bay)", "Trillium Health Partners (Mississauga)", "Windsor Regional Hospital (Windsor)", "Women's College Hospital (Toronto)"],
    "testing_laboratory": ["Children's Hospital of Eastern Ontario (Ottawa)", "Hamilton Health Sciences (Hamilton)", "Hospital for Sick Children (Toronto)", "Kingston Health Sciences Centre (Kingston)", "London Health Sciences Centre (London)", "North York General Hospital (Toronto)", "Sinai Health System (Toronto)"],
    ...
    "tested_genes": {"gene_symbol": {"gene_symbol": "string", "refseq_mrna": "string"}},
    ...
    "variants": [{
        ...
        "mega_hgvs": "string",  # New field for combined HGVS notation
